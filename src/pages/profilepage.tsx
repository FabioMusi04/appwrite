    ...
    return (
        <div className="flex grow bg-gray-100 dark:bg-gray-900 p-5 justify-center align-center">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-1/2">
                <h1 className="text-2xl font-bold my-4 text-gray-900 dark:text-gray-100 text-center">My Profile</h1>
                ...
                <div className="mb-4">
                    <p className={`${user.status ? 'text-green-500' : 'text-red-500'}`}>
                        Status: {user.status ? 'Enabled' : 'Disabled'}
                    </p>
                </div>
                <div className="mb-4">
                    <p className={`${user.emailVerification ? 'text-green-500' : 'text-red-500'}`}>
                        Email Verified: {user.emailVerification ? 'Yes' : 'No'}
                    </p>
                </div>
                <div className="mb-4">
                    <p className={`${user.phoneVerification ? 'text-green-500' : 'text-red-500'}`}>
                        Phone Verified: {user.phoneVerification ? 'Yes' : 'No'}
                    </p>
                </div>
                <div className="mb-4">
                    <p className={`${user.mfa ? 'text-green-500' : 'text-red-500'}`}>
